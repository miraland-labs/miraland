...
pub fn spl_token_instruction(instruction: SolartiTokenInstruction) -> Instruction {
    Instruction {
        program_id: miraland_sdk::pubkey::Pubkey::from(instruction.program_id.to_bytes()),
        accounts: instruction
            .accounts
            .iter()
            .map(|meta| AccountMeta {
                pubkey: miraland_sdk::pubkey::Pubkey::from(meta.pubkey.to_bytes()),
...
//     use {
//         super::*,
//         miraland_sdk::{message::Message, pubkey::Pubkey},
...
//         let keys: Vec<Pubkey> = repeat_with(miraland_sdk::pubkey::new_rand)
//             .take(10)
//             .collect();

...
pub mod tests {
    use {
        super::*,
        miraland_sdk::{account::Account, native_token::mln_to_lamports},
    };
    ...
    fn test_calculate_stake_weighted_timestamp_uses_median() {
        ...
        let pubkey4 = miraland_sdk::pubkey::new_rand();
        ...
        let stakes: HashMap<Pubkey, (u64, Account)> = [
            (
                pubkey0,
                (mln_to_lamports(1.0), Account::new(1, 0, &Pubkey::default())),
            ),
            (
                pubkey1,
                (mln_to_lamports(1.0), Account::new(1, 0, &Pubkey::default())),
        ...
        let stakes: HashMap<Pubkey, (u64, Account)> = [
            (
                pubkey0,
                (
                    mln_to_lamports(1_000_000.0), // 1/3 stake
                    Account::new(1, 0, &Pubkey::default()),
                ),
            ),
            (
        ...
        let stakes: HashMap<Pubkey, (u64, Account)> = [
            (
                pubkey0,
                (
                    mln_to_lamports(1_000_001.0), // 1/3 stake
                    Account::new(1, 0, &Pubkey::default()),
                ),
            ),
            (

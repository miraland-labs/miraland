use {
    ...
    miraland_runtime::{bank::Bank, epoch_stakes::NodeIdToVoteAccounts},
    miraland_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, miraland_runtime::epoch_stakes::NodeVoteAccounts};
    ...
    fn test_best_completed_slot_peer() {
        ...
        for ci in contact_infos.iter_mut() {
            ci.set_pubkey(miraland_sdk::pubkey::new_rand());
        }
        let slot = 9;

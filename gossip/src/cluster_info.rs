...
const MIN_STAKE_FOR_GOSSIP: u64 = miraland_sdk::native_token::LAMPORTS_PER_MLN;
...
#[frozen_abi(digest = "Ej32sjJFLCz3affT9oF3mGjsEVXkhRsyXXqa4FLA8wgz")]
...
impl ClusterInfo {
    ...
    pub fn get_node_version(&self, pubkey: &Pubkey) -> Option<miraland_version::LegacyVersion2> {
        let gossip_crds = self.gossip.crds.read().unwrap();
    ...
    pub fn gossip(
        ...
        let thread_pool = ThreadPoolBuilder::new()
            ...
            .thread_name(|i| format!("mlnRunGossip{i:02}"))
            .build()
            .unwrap();
        Builder::new()
    ...
    pub(crate) fn start_socket_consume_thread(
        ...
        let thread_pool = ThreadPoolBuilder::new()
            ...
            .thread_name(|i| format!("mlnGossipCons{i:02}"))
            .build()
            .unwrap();
    ...
    pub(crate) fn listen(
        ...
        let thread_pool = ThreadPoolBuilder::new()
            .num_threads(get_thread_count().min(8))
            .thread_name(|i| format!("mlnGossipWork{i:02}"))
            .build()
            .unwrap();
        Builder::new()

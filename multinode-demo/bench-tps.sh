...
usage() {
  ...
  echo " Run bench-tps "
  echo
  echo "   extra args: additional arguments are passed along to miraland-bench-tps"
  echo
  exit 1
}
...
default_arg --client-node-id "${MIRALAND_CONFIG_DIR}/bootstrap-validator/identity.json"

$miraland_bench_tps "${args[@]}"

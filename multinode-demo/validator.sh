...
OPTIONS:
  ...
  --node-sol MLN            - Number of MLN this node has been funded from the genesis config (default: $node_sol)
...
rpc_url=$($miraland_gossip $maybe_allow_private_addr rpc-url --timeout 180 --entrypoint "$gossip_entrypoint")

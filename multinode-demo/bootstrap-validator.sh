...
identity=$MIRALAND_CONFIG_DIR/bootstrap-validator/identity.json
vote_account="$MIRALAND_CONFIG_DIR"/bootstrap-validator/vote-account.json

ledger_dir="$MIRALAND_CONFIG_DIR"/bootstrap-validator
[[ -d "$ledger_dir" ]] || {

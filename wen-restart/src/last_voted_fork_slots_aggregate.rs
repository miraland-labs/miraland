use {
    crate::miraland::wen_restart_proto::LastVotedForkSlotsRecord,
    anyhow::Result,
    log::*,
    miraland_gossip::restart_crds_values::RestartLastVotedForkSlots,
...
mod tests {
    use {
        crate::{
            ...
            miraland::wen_restart_proto::LastVotedForkSlotsRecord,
        },
        miraland_gossip::restart_crds_values::RestartLastVotedForkSlots,

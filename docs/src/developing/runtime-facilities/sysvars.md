...
[`miraland-program`
crate](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/sysvar/index.html),
and outlined below.
...
- Layout: [Clock](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/clock/struct.Clock.html)
- Fields:
...
- Layout:
  [EpochSchedule](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/epoch_schedule/struct.EpochSchedule.html)
...
- Layout:
  [Fees](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/sysvar/fees/struct.Fees.html)
...
- Layout:
  [Instructions](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/sysvar/instructions/struct.Instructions.html)
...
- Layout:
  [RecentBlockhashes](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/sysvar/recent_blockhashes/struct.RecentBlockhashes.html)
...
- Layout:
  [Rent](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/rent/struct.Rent.html)
...
- Layout:
  [SlotHashes](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/slot_hashes/struct.SlotHashes.html)
...
- Layout:
  [SlotHistory](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/slot_history/struct.SlotHistory.html)
...
- Layout:
  [StakeHistory](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/stake_history/struct.StakeHistory.html)
...
- Layout:
  [EpochRewards](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/epoch_rewards/struct.EpochRewards.html)
...
- Layout:
  [LastRestartSlot](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/last_restart_slot/struct.LastRestartSlot.html)

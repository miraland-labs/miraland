...
Miraland contains a small handful of native programs, which are required to run
...
- Instructions: [SystemInstruction](https://docs.rs/miraland-program/VERSION_FOR_DOCS_RS/miraland_program/system_instruction/enum.SystemInstruction.html)
...
- Instructions: [config_instruction](https://docs.rs/miraland-config-program/VERSION_FOR_DOCS_RS/miraland_config_program/config_instruction/index.html)
...
- Instructions: [VoteInstruction](https://docs.rs/miraland-vote-program/VERSION_FOR_DOCS_RS/miraland_vote_program/vote_instruction/enum.VoteInstruction.html)

## Address Lookup Table Program

- Program id: `AddressLookupTab1e1111111111111111111111111`
- Instructions: [AddressLookupTableInstruction](https://docs.rs/miraland-sdk/VERSION_FOR_DOCS_RS/miraland_sdk/address_lookup_table/instruction/enum.ProgramInstruction.html)
...
instruction via a program id, the Miraland runtime will load both your the program
...
- Instructions: [new_ed25519_instruction](https://github.com/miraland-labs/miraland/blob/master/sdk/src/ed25519_instruction.rs#L45)
...
- Instructions: [new_secp256k1_instruction](https://github.com/miraland-labs/miraland/blob/1a658c7f31e1e0d2d39d9efbc0e929350e2c2bcb/sdk/src/secp256k1_instruction.rs#L31)

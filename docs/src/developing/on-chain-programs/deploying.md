...
to an ELF shared object containing BPF bytecode, and uploads it to the Miraland
...
The Miraland command line interface supports deploying programs, for more

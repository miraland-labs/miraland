...
The Miraland-Web3.js library aims to provide complete coverage of Miraland. The library was built on top of the [Miraland JSON RPC API](../clients/jsonrpc-api.md).

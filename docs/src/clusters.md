...
```bash
solana config set --url https://api.devnet-mln.miraland.top
```
...
```bash
solana config set --url https://api.testnet-mln.miraland.top
```
...
```bash
solana config set --url https://api.mainnet-mln.miraland.top
```

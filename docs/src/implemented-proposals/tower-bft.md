...
This design describes Miraland's _Tower BFT_ algorithm. It addresses the following problems:
...
The Miraland cluster generates a source of time via a Verifiable Delay Function we are calling [Proof of History](../cluster/synchronization.md).

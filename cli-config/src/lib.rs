...
//!
//! The configuration file used by the Miraland CLI includes information about the
//! RPC node to connect to, the path to the user's signing source, and more.
//! Other software than the Miraland CLI may wish to access the same configuration
//! and signer.
//!

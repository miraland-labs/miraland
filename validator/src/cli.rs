    ...
    return App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("snapshot_packager_niceness_adj")
                ...
                .takes_value(true)
                .validator(miraland_perf::thread::is_niceness_adjustment_valid)
            ...
            Arg::with_name("staked_nodes_overrides")
                ...
                .help(
                    "Provide path to a yaml file with custom overrides for stakes of specific \
                     ...
                     Format of the file: `staked_map_id: {<pubkey>: <MLN stake amount>}",
                ),
        )
        .arg(
        ...
        .arg(
            Arg::with_name("snapshot_archive_format")
                ...
                .alias("snapshot-compression") // Legacy name used by Miraland v1.5.x and older
        ...
        .arg(
            Arg::with_name("account_indexes")
                ...
                .takes_value(true)
                .multiple(true)
                .possible_values(&["program-id", "solarti-token-owner", "solarti-token-mint"])
                .value_name("INDEX")
...
pub fn test_app<'a>(version: &'a str, default_args: &'a DefaultTestArgs) -> App<'a, 'a> {
    return App::new("miraland-test-validator")
        ...
        .arg(
            Arg::with_name("faucet_mln")
                ...
                .help(
                    "Give the faucet address this much MLN in genesis. If the ledger already \
        ...
        .arg(
            Arg::with_name("faucet_per_time_mln_cap")
                ...
                .min_values(0)
                .max_values(1)
                .help("Per-time slice limit for faucet requests, in MLN"),
        )
        .arg(
            Arg::with_name("faucet_per_request_mln_cap")
                ...
                .min_values(0)
                .max_values(1)
                .help("Per-request limit for faucet requests, in MLN"),
        )
        .arg(
            Arg::with_name("geyser_plugin_config")
                .long("geyser-plugin-config")

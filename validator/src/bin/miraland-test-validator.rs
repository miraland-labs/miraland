...
const DEFAULT_FAUCET_MLN: f64 = 1_000_000.;
...
fn main() {
    ...
    let default_faucet_mln = DEFAULT_FAUCET_MLN.to_string();

    let matches = App::new("miraland-test-validator")
        ...
        .arg(
            Arg::with_name("faucet_port")
                ...
                .validator(miraland_validator::port_validator)
        ...
        .arg(
            Arg::with_name("account")
                ...
                .multiple(true)
                .help(
                    "Load an account from the provided JSON file (see `miraland account --help` on how to dump \
        ...
        .arg(
            Arg::with_name("dynamic_port_range")
                ...
                .takes_value(true)
                .validator(miraland_validator::port_range_validator)
                .help(
        ...
        .arg(
            Arg::with_name("faucet_mln")
                ...
                .takes_value(true)
                .value_name("MLN")
                .default_value(default_faucet_mln.as_str())
                .help(
    ...
    let faucet_lamports = sol_to_lamports(value_of(&matches, "faucet_mln").unwrap());

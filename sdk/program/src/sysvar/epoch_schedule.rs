...
//!
//! See also the Miraland [documentation on the epoch schedule sysvar][sdoc].
//!
...
//! }
//! #
//! # use miraland_program::sysvar::SysvarId;
...
//! # use miraland_sdk::sysvar::epoch_schedule::{self, EpochSchedule};
//! # use anyhow::Result;
//! #

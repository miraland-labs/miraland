//! Types for directing the execution of Miraland programs.
//!
//! Every invocation of a Miraland program executes a single instruction, as
...
//! the Miraland runtime. This allows flexibility in how programs behave, how they
...
pub enum InstructionError {
    ...
    /// by the Miraland runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across Miraland software versions.
    ///
...
/// A directive for a single invocation of a Miraland program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by Miraland
...
/// construction.
///
/// While Miraland is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the Miraland runtime coalesces all accounts used
...
///
/// Note that because the Miraland runtime schedules parallel transaction
...
/// which is the core of a Miraland transaction. It is created during the

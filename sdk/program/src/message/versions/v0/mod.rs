...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`solana_address_lookup_table_program`], [`miraland_client`], [`solana_sdk`], and [`anyhow`] crates.
    ///
    /// [`solana_address_lookup_table_program`]: https://docs.rs/miraland-address-lookup-table-program

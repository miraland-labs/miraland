...
// Allows macro expansion of `use ::miraland_sdk::*` to work within this crate
extern crate self as miraland_sdk;

#[cfg(feature = "full")]
pub use signer::signers;
// These miraland_program imports could be *-imported, but that causes a bunch of
// confusing duplication in the docs due to a rustdoc bug. #26211
#[allow(deprecated)]
pub use miraland_program::address_lookup_table_account;
#[cfg(not(target_os = "solana"))]
pub use miraland_program::program_stubs;
...
pub use miraland_sdk_macro::declare_deprecated_id;
...
/// use std::str::FromStr;
/// use miraland_sdk::{declare_id, pubkey::Pubkey};
///
/// # mod item_wrapper {
/// #   use miraland_sdk::declare_id;
...
/// assert_eq!(id(), my_id);
/// ```
pub use miraland_sdk_macro::declare_id;
...
/// assert_eq!(ID, my_id);
/// ```
pub use miraland_sdk_macro::pubkey;
/// Convenience macro to define multiple static public keys.
pub use miraland_sdk_macro::pubkeys;
#[rustversion::since(1.46.0)]
pub use miraland_sdk_macro::respan;

// Unused `miraland_sdk::program_stubs!()` macro retained for source backwards compatibility with older programs
#[macro_export]
#[deprecated(
    since = "1.4.3",

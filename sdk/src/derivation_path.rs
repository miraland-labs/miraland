...
impl DerivationPath {
    ...
    pub fn from_key_str(path: &str) -> Result<Self, DerivationPathError> {
        Self::from_key_str_with_coin(path, Miraland) // vanilla: Solana
    }
    ...
    pub fn new_bip44(account: Option<u32>, change: Option<u32>) -> Self {
        Self::new_bip44_with_coin(Miraland, account, change) // vanilla: Solana
    }
    ...
    fn from_uri(
        ...
        if let Some(query) = uri.query() {
            ...
            if let Some(key) = key {
                ...
                // generates a Solana/Solarti/Qthor/Mira/Miraland bip44 DerivationPath
...
mod tests {
    ...
    fn test_from_absolute_path_str() {
        ...
        // Test non-Solana/Solarti/Qthor/Mira/Miraland Bip44
        let s = "m/44'/999'/1/2";
        assert_eq!(
            DerivationPath::from_absolute_path_str(s).unwrap(),
            DerivationPath::new_bip44_with_coin(TestCoin, Some(1), Some(2))

...
/// mod item_wrapper {
/// use miraland_sdk::keyed_account::KeyedAccount;
/// use miraland_sdk::instruction::InstructionError;
/// use miraland_sdk::pubkey::Pubkey;
/// use miraland_sdk::declare_builtin;
///
...
///
/// # use item_wrapper::id;
/// assert_eq!(id(), miraland_sdk::system_program::ID);
/// ```
#[macro_export]

...
impl FeeStructure {
    pub fn new(
        mln_per_signature: f64,
        mln_per_write_lock: f64,
        ...
        let compute_fee_bins = compute_fee_bins
            ...
            .collect::<Vec<_>>();
        FeeStructure {
            lamports_per_signature: mln_to_lamports(mln_per_signature),
            lamports_per_write_lock: mln_to_lamports(mln_per_write_lock),
            compute_fee_bins,
        }
    }

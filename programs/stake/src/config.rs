...
#[allow(deprecated)]
use miraland_sdk::stake::config;
#[deprecated(
    since = "1.8.0",
    note = "Please use `miraland_sdk::stake::config` or `miraland_program::stake::config` instead"
)]
pub use miraland_sdk::stake::config::*;
use {
    bincode::deserialize,
    miraland_config_program::{create_config_account, get_config_data},
    miraland_sdk::{

...
mod tests {
    ...
    fn feature_set_old_warmup_cooldown_no_minimum_delegation() -> Arc<FeatureSet> {
        ...
        Arc::get_mut(&mut feature_set)
            .unwrap()
            .deactivate(&feature_set::stake_raise_minimum_delegation_to_1_mln::id());
        feature_set
    }
                ...
                (
                    *pubkey,
                    if clock::check_id(pubkey) {
                        ...
                        AccountSharedData::new(0, 0, &miraland_vote_program::id())
    ...
    fn test_stake_process_instruction_decode_bail(feature_set: Arc<FeatureSet>) {
        ...
        let vote_account = AccountSharedData::new(0, 0, &miraland_vote_program::id());

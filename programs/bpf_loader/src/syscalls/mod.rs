...
declare_builtin_function!(
    ...
    fn rust(
        ...
        use miraland_sdk::alt_bn128::prelude::{ALT_BN128_ADD, ALT_BN128_MUL, ALT_BN128_PAIRING};
        let budget = invoke_context.get_compute_budget();
...
declare_builtin_function!(
    ...
    fn rust(
        ...
        use miraland_sdk::alt_bn128::compression::prelude::{
...
mod tests {
    ...
    use {
        ...
        core::slice,
        miraland_program_runtime::{invoke_context::InvokeContext, with_mock_invoke_context},
        solana_rbpf::{
    ...
    fn test_syscall_sol_alloc_free() {
        // large alloc
        {
            ...
            let result = SyscallAllocFree::rust(
                invoke_context,
                miraland_sdk::entrypoint::HEAP_LENGTH as u64,
                0,
                0,
                0,
                0,
    ...
    fn test_create_program_address() {
        // These tests duplicate the direct tests in miraland_program::pubkey

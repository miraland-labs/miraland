...
pub fn process_instruction(
    ...
    match instruction {
        ...
        ProofInstruction::VerifyRangeProofU64 => todo!(),
        ProofInstruction::VerifyBatchedRangeProofU64 => todo!(),
        ProofInstruction::VerifyBatchedRangeProofU128 => todo!(),
        ProofInstruction::VerifyBatchedRangeProofU256 => todo!(),
        ProofInstruction::VerifyCiphertextCommitmentEquality => todo!(),
        ProofInstruction::VerifyGroupedCiphertext2HandlesValidity => todo!(),
        ProofInstruction::VerifyBatchedGroupedCiphertext2HandlesValidity => todo!(),
        ProofInstruction::VerifyFeeSigma => todo!(),
    }
}
...
//!
//! The [`PubsubClient`] implements [Miraland WebSocket event
//! subscriptions][spec].
//!
//! [spec]: https://docs.miraland.top/api/websocket#subscription-websocket
//!
...
//! `--rpc-pubsub-enable-vote-subscription` to `miraland-validator`. When these
//! methods are disabled, the RPC server will return a "Method not found" error
//! message.
//!
//! [`block_subscribe`]: https://docs.rs/miraland-rpc/latest/miraland_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.block_subscribe
//! [`vote_subscribe`]: https://docs.rs/miraland-rpc/latest/miraland_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.vote_subscribe
//!
//! # Examples
//!
...
//! use miraland_pubsub_client::nonblocking::pubsub_client::PubsubClient;
//! use std::sync::Arc;
...
impl PubsubClient {
    ...
    ///
    /// [`accountSubscribe`]: https://docs.miraland.top/api/websocket#accountsubscribe
    ...
    /// `--rpc-pubsub-enable-block-subscription` to `miraland-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`blockSubscribe`] RPC method.
    ///
    /// [`blockSubscribe`]: https://docs.miraland.top/api/websocket#blocksubscribe
    ...
    ///
    /// [`logsSubscribe`]: https://docs.miraland.top/api/websocket#logssubscribe
    ...
    ///
    /// [`programSubscribe`]: https://docs.miraland.top/api/websocket#programsubscribe
    ...
    ///
    /// This method is disabled by default. It can be enabled by passing
    /// `--rpc-pubsub-enable-vote-subscription` to `miraland-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`voteSubscribe`] RPC method.
    ///
    /// [`voteSubscribe`]: https://docs.miraland.top/api/websocket#votesubscribe
    ...
    /// validator.
    ///
    /// [root]: https://docs.miraland.top/terminology#root
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`rootSubscribe`] RPC method.
    ///
    /// [`rootSubscribe`]: https://docs.miraland.top/api/websocket#rootsubscribe
    ...
    ///
    /// [`signatureSubscribe`]: https://docs.miraland.top/api/websocket#signaturesubscribe
    ...
    ///
    /// [`slotSubscribe`]: https://docs.miraland.top/api/websocket#slotsubscribe
    ...
    ///
    /// [`slotUpdatesSubscribe`]: https://docs.miraland.top/api/websocket#slotsupdatessubscribe

    ...
    pub fn finalize(self) -> Hash {
        ...
        if let Ok(dir) = std::env::var("MIRALAND_ABI_DUMP_DIR") {
            let thread_name = std::thread::current()
                ...
                .replace(':', "_");
            if thread_name == "main" {
                error!("Bad thread name detected for dumping; Maybe, --test-threads=1? Sorry, MIRALAND_ABI_DUMP_DIR doesn't work under 1; increase it");
            }
...
mod tests {
    ...
    mod bitflags_abi {
        ...
        bitflags::bitflags! {
            ...
            #[frozen_abi(digest = "48ahAREMEmKgaP2KCexJ2oGpLC65UcSThF6zywcYKC8B")]
        ...
        //   miraland_frozen_abi::abi_digester::tests::_::InternalBitFlags
